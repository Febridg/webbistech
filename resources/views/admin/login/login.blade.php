...
<head>
    <title>Login Admin Bistech</title>
    <meta charset="UTF-8">
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <form class="login100-form validate-form" method="post" action="http://localhost/bistech/admin/login">
                    {{ csrf_field() }}
                    ...
                    <div class="wrap-input100 validate-input">
                        ...
                        <span class="focus-input100" data-placeholder="Username" name="username"></span>
                    </div>
